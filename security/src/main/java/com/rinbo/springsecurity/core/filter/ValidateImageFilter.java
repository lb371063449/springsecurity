...
//验证码验证filter
@Component
public class ValidateImageFilter extends OncePerRequestFilter implements InitializingBean {
    ...
    public void validate(ServletWebRequest request) {
        ...
        ImageCode codeInSession = (ImageCode) request.getRequest().getSession().getAttribute("SESSION_KEY_IMAGE");
